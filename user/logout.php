...
session_start();
	if(empty($_SESSION['SESS_MEMBER_ID'])):
		header('Location:../user/visitor_dashb.php');
	endif;
?>
<!DOCTYPE html>
<html>
...
$sql = mysqli_query($conn, "SELECT * FROM user WHERE EMP_ID = $id_no ");
$result = mysqli_fetch_array($sql);

mysqli_query($conn,"INSERT INTO audit_log(name,position,action,timedate) VALUES('$result[EMP_FNAME]','$result[POSITION]','LOGGED OUT IN SYSTEM AT',NOW())")
or die(mysqli_error($conn));

session_destroy();
	
 echo '<meta http-equiv="refresh" content="2;url=../user/signin.php">';
