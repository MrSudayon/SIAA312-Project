...
<head>
	...
	<title>To Recieve - Boss B Burgers</title>
<style>
...
<div class="row">
<div class="header1">
	<h1>Lists of Delivered Items</h1>
...
<?php
		...
		$query=mysqli_query($conn,"select * from cart where C_ID='$id' and status='On Delivery' order by ordercode")or die(mysqli_error($conn));
