...
<div class="topnav" id="myTopnav" style="background-color:#525252;">
  <a class="history" href="history.php" style="float: right;" autofocus="autofocus">History</a>
...
<?php
		...
		$query=mysqli_query($conn,"select * from cart where C_ID='$id' and status='Completed' order by ID")or die(mysqli_error($conn));
